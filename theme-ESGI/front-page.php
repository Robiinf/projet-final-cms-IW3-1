...
<main>
    ...
    <section class="intro-section">
        <h1 class="margin-left"><?= get_theme_mod("main_title", "A really professional structure for all your events!")?></h1>
        <div class="flex-end">
    ...
    <section class="our-services">
        <h2><?= get_theme_mod("our_services_title", 'Our Services')?></h2>
